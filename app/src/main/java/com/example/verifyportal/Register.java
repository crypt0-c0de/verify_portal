            ...
            public void onClick(View v) {
                if(!verificationInProgress){
                    ...
                    if(!userOTP.isEmpty() && userOTP.length() == 6){
                        PhoneAuthCredential credentail = PhoneAuthProvider.getCredential(verificationId,userOTP);
                        verifyAuth(credentail);
                    }else{
    ...
    private void requestOTP(String phoneNum){
        PhoneAuthProvider.getInstance().verifyPhoneNumber(phoneNum, 60L, TimeUnit.SECONDS, this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeAutoRetrievalTimeOut(@NonNull String s) {
                ...
                Toast.makeText(Register.this, "OTP Expired, Re - Request OTP.", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onVerificationFailed(@NonNull FirebaseException e) {

                Toast.makeText(Register.this,"Cannot Create Account "+ e.getMessage(),Toast.LENGTH_LONG).show();
